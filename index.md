...
The v0.6.0 real-data manifest uses asymmetric coverage because the
currently available 2025-26 source set includes classroom and student
files, but no canonical 2025-26 budget file.
...
classroom-year records, 7,409 classroom-year records, and 116,689
student-year records. These are aggregate processing counts, not
row-level data.
