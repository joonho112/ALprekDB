...
The package ships 22 public CSV files in v0.7.0: 12 codebooks and 10 column
mappings. Eight of those files support the new Applications module.
...
stopifnot(nrow(csv_inventory) == 22L)
stopifnot(sum(csv_inventory$role == "codebook") == 12L)
stopifnot(sum(csv_inventory$role == "mapping") == 10L)
stopifnot(sum(csv_inventory$rows[csv_inventory$role == "codebook"]) == 267L)
