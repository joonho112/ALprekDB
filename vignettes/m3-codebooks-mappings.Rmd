...
The package ships 14 public CSV files: 8 codebooks and 6 column mappings.
...
stopifnot(nrow(csv_inventory) == 14L)
stopifnot(sum(csv_inventory$role == "codebook") == 8L)
stopifnot(sum(csv_inventory$role == "mapping") == 6L)
stopifnot(sum(csv_inventory$rows[csv_inventory$role == "codebook"]) == 225L)
stopifnot(sum(csv_inventory$rows[csv_inventory$role == "mapping"]) == 715L)
